...
public class GenerateQuizInteractor implements GenerateQuizInputBoundary {
    ...
    public void execute(GenerateQuizInputData inputData) {
        ...
        // // 2. Call Gemini API to generate quiz questions (best-effort via
        // reflection),
        ...
        // if ((name.contains("generate") || name.contains("create") ||
        ...
        // "options", List.of("Search sorted array", "Search unsorted array", "Sort then
        // search"),
        // "answer", "Search sorted array"),
        // Map.of(
        // "id", 2,
        // "text", "Which book is authored by Joshua Bloch?",
        // "options", List.of("Clean Code", "Effective Java", "Introduction to
        // Algorithms"),
        ...
        // String name = m.getName().toLowerCase();
        // if ((name.contains("save") || name.contains("insert") ||
        // name.contains("add"))
        ...
        // // 5. Prepare success or failure view via output boundary (best-effort via
        // // reflection)
        // try {
        // for (Method m : outputBoundary.getClass().getMethods()) {
        // String name = m.getName().toLowerCase();
        // if (saved && (name.contains("success") || name.contains("present")) &&
        // m.getParameterCount() == 1) {
        // m.invoke(outputBoundary, studyQuiz);
        // return;
        // }
        // if (!saved && (name.contains("failure") || name.contains("error") ||
