...
public class UploadReferenceMaterialInteractor implements UploadReferenceMaterialInputBoundary {
    ...
    public void execute(UploadReferenceMaterialInputData inputData) {
        ...
        // boolean isDuplicate = materialRepository.findByFingerprint(fingerprint) != null;
        ...
        UploadReferenceMaterialOutputData outputData = getUploadReferenceMaterialOutputData();
    ...
    private static UploadReferenceMaterialOutputData getUploadReferenceMaterialOutputData() {
        ...
        // If concrete types/methods are available, replace the comments below with real calls:
        // ReferenceMaterial material = new ReferenceMaterial(simulatedFileName, simulatedStoragePath, fingerprint, ...);
