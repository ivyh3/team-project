...
public class StudyQuizView extends View {
    ...
    private JButton createSubmitButton() {
        ...
        submit.addActionListener(e -> {
            ...
            if (selectedAnswer == -1) {
                JOptionPane.showMessageDialog(this, "Please select an answer before submitting.", "No Answer Selected", JOptionPane.WARNING_MESSAGE);
                return;
            }
    ...
    private JButton createNextButton() {
        ...
        next.addActionListener(e -> {
            ...
            if (currentQuestionIndex < questions.size()) {
                ...
                int correctAnswers = (int) questions.stream().filter(Question::isWasCorrect).count();
                JOptionPane.showMessageDialog(this, "Quiz completed! Final Score: " + correctAnswers + "/" + questions.size(), "Quiz Completed", JOptionPane.INFORMATION_MESSAGE);
    ...
    static void validQuestion(List<Question> questions, int currentQuestionIndex, JLabel questionLabel, JRadioButton[] answerButtons) {
