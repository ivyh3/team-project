# AI Study Companion
A productivity app made in Java for CSC207 Software Design. This app allows users to create an account, track how much time they spend studying through timed sessions, and solve AI-powered practice questions based on their textbooks they upload.
...
2. They can navigate to the settings -> manage uploaded files to upload their textbook(s)
...
## APIs
- *Gemini API*: used to generate study quizzes
- *Firebase API wrapper*: used for accounts and persistent storage
